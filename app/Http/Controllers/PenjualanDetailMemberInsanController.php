...
class PenjualanDetailMemberInsanController extends Controller
{
   ...
   public function checkPin($id){
      $member = Member::where('kode_member',$id)
      ->first();
   ...
   public function printNota(){
      ...
      return view('penjualan_detail_member_insan.selesai', compact('setting'));
   ...
   public function notaPDF(){
     ...
     $detail = PenjualanDetail::select(\DB::raw('penjualan_detail.kode_produk,
      ...
      $pdf = PDF::loadView('penjualan_detail_member_insan.notapdf', compact('detail','toko','musawamah','penjualan', 'setting', 'no'));
