...
class PenjualanController extends Controller{
  ...
  public function listDetail($awal,$akhir){
    ...
    if ($awal == $akhir) {
      ...
      $penjualan = DB::table('penjualan_detail')->select(DB::raw('SUBSTR(penjualan.created_at,1,10) AS tanggal,penjualan_detail.id_penjualan,users.unit,penjualan.kode_member as member,member.nama,penjualan_detail.kode_produk,produk.nama_produk , penjualan_detail.harga_jual,penjualan_detail.harga_beli,penjualan_detail.sub_total_beli,penjualan_detail.jumlah,sub_total,penjualan_detail.id_penjualan_detail as detail
      '))
